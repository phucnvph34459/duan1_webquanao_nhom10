        ...
        <div class="col-sm-4 col-lg-7 d-none d-lg-block">
          <div class="header-navigation-area">
            <ul class="main-menu nav position-relative">
              <li class="has-submenu"><a href="index.php">Trang chủ</a></li>
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="product-thumb">
                    <div class="zoom zoom-hover">
                      <a class="lightbox-image" data-fancybox="gallery" href="app/view/upload/images (2).jpg">
                        <img src="app/view/upload/images (2).jpg" alt="Image-HasTech">
                      </a>
                    </div>
                  </div>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="product-single-info">
                    <h4 class="title">ÁO phông trắng nữ</h4>
                    <div class="prices">
                    ...
                    <div class="rating-box-wrap">
                      ...
                      <div class="review-status">
                        <a href="javascript:void(0)">( Đức đã bình luận )</a>
                      </div>
                    </div>
                    <p>Đây là chiếc áo mà Đức đã tự tay thiết kế để tặng sinh nhật Phúcnv nên rất quý giá . Nhưng phúcnv lại ko tặng lại ĐỨc 1 bữa ăn sáng mà đi làm tóc xoăn sâu promax</p>
                    <div class="product-action-simple">
                      <div class="product-quick-action">
                        ...
                        <a class="btn-product-add" href="#/">Thêm giỏ hàng</a>
                      </div>
                     
                      <div class="payment-button">
                        <a href="#/" class="btn-payment">Mua ngay</a>
                      </div>
            ...
            <div class="product-review-tabs-content">
              <ul class="nav product-tab-nav" id="ReviewTab" role="tablist">
                <li role="presentation">
                  <a class="active" id="description-tab" data-bs-toggle="pill" href="#description" role="tab" aria-controls="description" aria-selected="true">Mô Tả</a>
                </li><li role="presentation">
                  <a id="reviews-tab" data-bs-toggle="pill" href="#reviews" role="tab" aria-controls="reviews" aria-selected="false">Đánh giá</a>
                </li><li role="presentation">
                  <a id="shipping-policy-tab" data-bs-toggle="pill" href="#shipping-policy" role="tab" aria-controls="shipping-policy" aria-selected="false">chính sách vận chuyển</a>
                </li><li role="presentation">
                  <a id="size-chart-tab" data-bs-toggle="pill" href="#size-chart" role="tab" aria-controls="size-chart" aria-selected="false">Biểu đồ kích thước</a>
                </li>
              </ul>
              <div class="tab-content product-tab-content" id="ReviewTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                  <div class="product-description">
                    <p class="mb-0">Có nhiều biến thể của các đoạn của Lorem Ipsum có sẵn, nhưng phần lớn đã bị thay đổi dưới một hình thức nào đó, bằng cách hài hước, hoặc những từ ngẫu nhiên không thể tin được. Nếu bạn định sử dụng một đoạn văn của Lorem Ipsum, bạn cần chắc chắn rằng không có bất cứ điều gì đáng xấu hổ ẩn ở giữa văn bản. Tất cả các trình tạo ipsum lorem trên internet có xu hướng lặp lại các khối được xác định trước khi cần thiết, làm cho đây trở thành công cụ tạo thực sự đầu tiên trên internet. Nó sử dụng từ điển hơn 200 từ Latin, kết hợp với một số ít các cấu trúc câu mô hình, để tạo ra Lorem Ipsum có vẻ hợp lý. Do đó, Lorem Ipsum được tạo ra luôn không có sự lặp lại, hài hước được tiêm hoặc các từ không đặc biệt, v.v..</p>
                  </div>
                </div>
                  ...
                  <div class="product-review-content">
                    <div class="review-content-header">
                      ...
                      <div class="review-info">
                        ...
                        <span class="review-caption">Dựa trên 7 đánh giá</span>
                        <span class="review-write-btn show">Viết một đánh giá</span>
                      </div>
                    </div>

                    <!--== Start Reviews Form Item ==-->
                    <div class="reviews-form-area show">
                      <h4 class="title">Viết một đánh giá</h4>
                      <div class="reviews-form-content">
                        <form action="#">
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label for="for_name">Họ tên</label>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <label for="for_comment"> đánh giá (1500)</label>
                    ...
                    <div class="reviews-content-body">
                      ...
                      <div class="review-item">
                        ...
                        <p>Nó đã tồn tại không chỉ năm thế kỷ, mà còn là bước nhảy vọt vào cách sắp xếp điện tử, về cơ bản vẫn không thay đổi. Nó đã được phổ biến vào những năm 1960 với việc phát hành các tấm letraset có chứa các đoạn Ipsum Lorem, và gần đây với các phần mềm xuất bản máy tính để bàn như Aldus Pagemaker bao gồm các phiên bản của Lorem Ipsum.</p>
                      ...
                      <div class="review-item">
                        ...
                        <p>Giày thể thao màu trắng yêu thích của tôi từ Splurge để tiết kiệm 1500s được sao chép dưới đây cho những người quan tâm. Các phần 1.10.32 và 1.10.33 Từ "De Finibus Bonorum et Malorum" của Cicero cũng được sao chép dưới dạng gốc chính xác của chúng, kèm theo các phiên bản tiếng Anh từ bản dịch năm 1914 của H. Rackham.</p>
                ...
                <div class="tab-pane fade" id="shipping-policy" role="tabpanel" aria-labelledby="shipping-policy-tab">
                  <div class="product-shipping-policy">
                    <div class="section-title">
                      <h2 class="title">Chính sách vận chuyển cho cửa hàng của chúng tôi</h2>
                      <p>Gồm các mục</p>
                    </div>
                    <ul class="shipping-policy-list">
                      <li>         1.Phí Vận Chuyển:
                        Nhiều trang web áp dụng phí vận chuyển dựa trên khu vực địa lý hoặc số lượng hàng hóa.
                        Có thể có chính sách miễn phí vận chuyển cho đơn đặt hàng vượt qua một giá trị nhất định.
                        </li>
                      <li>2. Thời Gian Giao Hàng
                        Cung cấp thông tin chi tiết về thời gian giao hàng dự kiến.
                      Có thể có tùy chọn vận chuyển nhanh với chi phí cao hơn.
                      </li>
                      <li>3.Vận Chuyển Quốc Tế:
                        Nếu trang web phục vụ nhiều quốc gia, chính sách vận chuyển quốc tế sẽ được mô tả cụ thể.
                        Có thể có chi phí vận chuyển cao hơn và thời gian giao hàng dài hơn cho đơn đặt hàng quốc tế.</li>
                      <li>4.Theo Dõi Đơn Hàng:
                        Cung cấp dịch vụ theo dõi đơn hàng để khách hàng có thể theo dõi quá trình vận chuyển của đơn hàng của họ.
                        </li>
                      <li> 5.Chính Sách Trả Hàng và Hoàn Tiền:
                        Quy định rõ ràng về việc trả hàng và hoàn tiền, đồng thời cung cấp hướng dẫn cụ thể về cách thực hiện quy trình này.
                      </li>
                      <li>6.Chính Sách Bảo Hiểm:
                        Nếu có, mô tả chính sách bảo hiểm cho trường hợp hàng hóa bị mất hoặc hỏng hóc trong quá trình vận chuyển.</li>
                    
                            <li>7.Yêu Cầu Ký Nhận:
                              Thông tin về việc liệu có cần chữ ký khi nhận hàng không, đặc biệt là đối với các đơn đặt hàng có giá trị lớn.</li>
                              <li>8.Giao Hàng An Toàn và Bảo Mật:
                                Chính sách đảm bảo rằng quá trình giao hàng được thực hiện một cách an toàn và bảo mật.</li>
                    </ul>
                ...
                <div class="tab-pane fade" id="size-chart" role="tabpanel" aria-labelledby="size-chart-tab">
                  <div class="product-size-chart">
                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          <td class="cun-name"><span>Đức</span></td>
                          <td>18</td>
                          <td>20</td>
                          <td>22</td>
                          <td>24</td>
                        ...
                        <tr>
                          <td class="cun-name"><span>Việt Nam</span></td>
                          <td>46</td>
                          <td>48</td>
                          <td>50</td>
                          <td>52</td>
                        ...
                        <tr>
                          <td class="cun-name"><span>Mĩ</span></td>
                          <td>14</td>
                          <td>16</td>
                          <td>18</td>
                          <td>20</td>
...
<!-- Mirrored from template.hasthemes.com/julie/julie/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Nov 2023 13:19:57 GMT -->
</html>